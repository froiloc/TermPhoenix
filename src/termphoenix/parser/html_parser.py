...
class HTMLParser:
    ...
    TEXT_CONTAINER_TAGS = {
        ...
        'li', 'td', 'th', 'caption', 'figcaption', 'blockquote', 'q', 'cite'
    }
    ...
    def _extract_text_tokens(self, soup: BeautifulSoup) -> List[TextToken]:
        """Extract text tokens with emphasis information and proper positioning."""
        tokens = []
        absolute_position = 0
        text_group_id = 0
        ...
        for node in text_nodes:
            ...
            for sentence_index, sentence in enumerate(sentences):
                ...
                for word_index, word in enumerate(words):
                    ...
                    is_capitalized = cleaned_word[0].isupper() if cleaned_word else False
    ...
    def _get_node_emphasis(self, node: PageElement) -> Set[EmphasisType]:
        ...
        while current and current.name:
            ...
            # Special case for title tag
                ...
                emphasis.add(EmphasisType.HEADER)  # Treat title as highest-level header
    ...
    def _is_sentence_start(self, node: PageElement, word: str) -> bool:
        ...
        parent = node.parent
        if parent and parent.name in ['p', 'div', 'li', 'td', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6']:
